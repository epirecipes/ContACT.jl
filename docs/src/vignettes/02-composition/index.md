...
```
    ...
    Scenario analysis (spectral radius as R₀ proxy):
      Normal:          10.21
      School closure:  6.62
      Lockdown (WFH):  4.59
      Full lockdown:   2.09
...
```
    ...
    Pipeline: Survey → 16-group → 4-group → symmetrise → 3-region
    Final size: 12 groups
    Spectral radius: 11.76
