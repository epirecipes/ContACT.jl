---
title: "The Categorical Framework"
subtitle: "ACSets, Schemas, and Functorial Data Migration"
author: "Simon Frost"
date: today
format:
  html:
...
1. **Schema-enforced structure**: Type-safe relationships between participants,
   contacts, and age groups, preventing structural errors at construction.
2. **Functorial data migration** ($\Sigma_f$, $\Delta_f$): Principled coarsening
   and restriction of age-structured data along morphisms.
...
valid participant, and every `:part_group`/`:cnt_group` points to a valid age group.
...
$f: G_{\mathrm{fine}} \to G_{\mathrm{coarse}}$ between age-group objects.
...
# Step 3: Symmetrise (idempotent endomorphism)
