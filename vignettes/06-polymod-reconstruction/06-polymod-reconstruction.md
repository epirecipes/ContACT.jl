...
```
    ...
    Participants: 1012, Contacts: 11876
...
```
    ...
    Survey: 968 participants, 11372 contacts
...
```
    ...
    Day-type groups: ["weekday", "weekend"]
    Product groups (6): ["[0,18):weekday", "[0,18):weekend", "[18,65):weekday", "[18,65):weekend", "65+:weekday", "65+:weekend"]
...
|----------|---------|-------------|
| `▷` | `\triangleright` | Survey -> matrix functor |
| `↔` | `\leftrightarrow` | Symmetrise (reciprocity, prefix) |
| `⊠` | `\boxtimes` | Constrained lift |
| `↓` | `\downarrow` | Coarsen (left Kan extension) |
| `×` | `\times` | Product partition |
